...
module Aws::DataPipeline
  module Types
    ...
    alias attributeNameString = String

    alias attributeValueString = String

    alias boolean = Bool

    alias cancelActive = Bool
    ...
    alias longString = String

    alias pipelineList = Array(PipelineIdName)
