...
module Aws::AccessAnalyzer
  module Types
    ...
    alias ConditionKeyMap = Hash(String,String)
    ...
    alias FindingSourceType = String

    alias FindingStatus = String
    ...
    alias PrincipalMap = Hash(String,String)
